...
@section('content')
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            document.getElementById('dynamicForm').addEventListener('submit', function(event) {
                ...
                // Add image submit handling with FormData
                const form = this;
                const formData = new FormData(form);

                fetch('/api/replaceMapImage', {
                        method: 'POST',
                        headers: {
    ...
    <section class="h-screen flex items-center justify-center">
        ...
        <div class="container mx-auto max-w-xl bg-[rgba(33,33,33)] p-8 rounded-xl shadow-lg">
            <h1 class="text-white text-[4rem] mb-6 uppercase font-black text-center">Change Map <span
                    class="text-[rgb(0,168,213)]">Image</span></h1>
            <br>
            <form enctype="multipart/form-data" id='dynamicForm' action="{{ route('replaceMapImage') }}" method="POST"
                class="mb-6">
                @csrf
                <label for="image_path"
                    class="text-[rgb(255,255,255)] text-[1.2rem] font-black [text-shadow:_0_0_2px_black]">Image
                    Path:</label>
                <br>
                <br>
                <input
                    ...
                    type="file" id="image_path" name="image" accept="image/*">
                <br>
                <br>
